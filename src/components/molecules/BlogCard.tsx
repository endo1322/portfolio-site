...
export const BlogCard = (props: BlogCardProps) => {
  ...
  return (
    <div className="h-[9.5rem] my-3 p-2 bg-white hover:bg-neutral-300 rounded-lg relative flex items-center">
      ...
      <div className="flex-grow min-w-0 max-w-full">
        ...
        <div className="flex flex-col px-2 h-[6.8rem]">
          ...
          <div className="flex flex-row overflow-auto max-w-full">
