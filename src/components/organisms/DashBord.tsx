  ...
  return (
    <div className={`flex flex-col p-5 h-full ${props.className}`}>
      <div className="flex flex-col h-full justify-between gap-5">
        <div className="flex flex-row h-[60%] bg-lime-100">
          <div className="flex flex-col w-1/3 justify-between gap-5 bg-lime-200">
            ...
            <div className="flex h-4/5 w-full">
              <ProfileCard className="shadow-lg min-w-[14rem] max-w-[24rem] m-auto" />
            </div>
          </div>
          <div className="flex flex-col w-2/3 pl-5 justify-between gap-5 bg-blue-200">
